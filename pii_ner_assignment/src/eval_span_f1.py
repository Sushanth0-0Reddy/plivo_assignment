...
def main():
    ...
    ap.add_argument("--metrics_out", default=None, help="Optional path to dump metrics JSON.")
    args = ap.parse_args()
    ...
    for lab in sorted(labels):
        ...
        per_entity_metrics[lab] = {"precision": p, "recall": r, "f1": f1}
        macro_f1_sum += f1
        macro_count += 1
    ...
    if args.metrics_out:
        ...
        logging.info("Wrote metrics JSON to %s", args.metrics_out)
